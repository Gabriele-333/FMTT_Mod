...
public class MagicCrystal extends BaseCrystal{
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath("fmtt", "textures/entity/magic_crystal.png");

    public MagicCrystal(EntityType<?> type, Level level) {
        super(type, level);
    }
